...
parser.add_argument("--sub", "--substitution", type=str, dest="f_sub", metavar="SUBSTITUTION_FILE",
                    help="file detailing substitutions to make in one or more SLiM modules before merge, especially useful if the same module is used multiple times (such as add_mutation_type.slim)")
